...
// тут не особо понятно как должна выглядеть наша БД
...
// всё-таки кажется лучше будет выбрать дерево
// его можно очень просто хранить просто как массив индексов (в каждом элементе хранится индекс его родителя)
// и такой массив очень просто сериализировать
// в нём также могут быть "противоречивые состояния", например, когда у нас цикл или несколько корней
